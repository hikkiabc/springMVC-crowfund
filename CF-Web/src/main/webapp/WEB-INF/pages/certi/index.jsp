                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <c:forEach items="${list}" var="i">
                                        <tr>
                                            <td>${i.name}</td>
                                            <td><input type="checkbox" accType="1" certiId="${i.id}"></td>
                                            <td><input type="checkbox" accType="2" certiId="${i.id}"></td>
                                            <td><input type="checkbox" accType="3" certiId="${i.id}"></td>
                                            <td><input type="checkbox" accType="4" certiId="${i.id}"></td>
                                        </tr>
                                    </c:forEach>
...
<script>
    ...
    $(function () {
        ...
        <c:forEach items="${accTypeCertiList}" var="i">

         $(":checkbox[certiId='${i.certi_id}'][accType='${i.acc_type}']")[0].checked=true
    </c:forEach>

        $(":checkbox").click(function () {
    if (this.checked){
        $.ajax({
            url:'${contextPath}/certi/insertCertiAccType',
            data:{certiId:$(this).attr("certiId"),accType:$(this).attr("accType")},
            success(s){
        ...
        $.ajax({
            url:'${contextPath}/certi/deleteCertiAccType',
            data:{certiId:$(this).attr("certiId"),accType:$(this).attr("accType")},
            success(s){
