...
<%--                        </div>--%>
<%--                    </form>--%>
    <div onclick="window.location.href='${contextPath}/member/toVerify'"><c:choose>
        <c:when test="${user.status==0}">
            Not-Verified
        </c:when> <c:when test="${user.status==1}">
        Being Verified
    </c:when> <c:when test="${user.status==2}">
        Verified
    </c:when>
    </c:choose></div>
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="#pablo">${user.nickname}
