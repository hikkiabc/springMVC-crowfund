                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="name" type="text" class="form-control" placeholder="Username" value="michael23">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">url</label>
                                                <input id="url" type="text" class="form-control" placeholder="Email">
                                            </div>
                                        </div>
                                    </div>
        ...
        var index = null
            $("#submit").click(()=>{
                ...
                $.ajax({
                    ...
                    data:{name:$("#name").val(),url:$("#url").val(),pid:${param.pId}},
                    method:'post',
