                                ...
                                <form id="form">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="name" type="text" class="form-control" placeholder="Username" value="${permission.name}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">url</label>
                                                <input id="url" type="text" class="form-control" value="${permission.url}" placeholder="Email">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="name" type="text" class="form-control" placeholder="Company" value="Mike">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>type</label>
                                                <input id="type" type="text" class="form-control" placeholder="Home Address" value="Bld Mihail Kogalniceanu, nr. 8 Bl 1, Sc 1, Ap 09">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="username" type="text" class="form-control" placeholder="City" value="Mike">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <button id="submit" type="submit" class="btn btn-info btn-fill pull-right">Update Profile</button>

                                    <button id="reset" type="submit" class="btn btn-info btn-fill pull-right">Reset</button>
                    ...
                    <div class="col-md-4">
                        <div class="card card-user">
                            ...
                            <div class="content">
                                <div class="author">
                                    <a href="#">
                                        <img class="avatar border-gray" src="${contextPath}/model/dashboard/BS3/assets/img/faces/face-3.jpg" alt="..."/>
        ...
        var index = null
            $("#submit").click(()=>{
                ...
                $.ajax({
                    ...
                    data:{name:$("#name").val(),url:$("#url").val(),id:${permission.id}},
                    method:'post',
                    beforeSend:()=>index=layer.msg('Doing Request', {icon: 6}),
                    success(res){
                        console.log(res)
                        layer.close(index)
                        if(res){
                            window.location.href="${contextPaht}/permission/toIndex"
