                                ...
                                <form id="form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>type</label>
                                                <input id="type" type="text" class="form-control" placeholder="Home Address" value="${user.type}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>username</label>
                                                <input id="username" type="text" class="form-control" placeholder="City" value="${user.username}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
        ...
        var index = null
            $("#submit").click(()=>{
                ...
                $.ajax({
                    ...
                    data:{username:$("#username").val(),type:$("#type").val(),id:${user.id}},
                    method:'post',
                    beforeSend:()=>index=layer.msg('Doing Edit', {icon: 6}),
                    success(res){

                        layer.close(index)
                        if(res.success){
                            window.location.href="${contextPath}/user/goUserIndex"
