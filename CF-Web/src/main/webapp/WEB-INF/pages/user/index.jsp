...
<%--                </c:if>--%>
<%--                <c:if test="${page.pageNum!=1}">--%>
<%--                    <li class="page-item "><a href="${contextPaht}/user/queryUserPages?pageNum=${page.pageNum-1}">Previous</a></li>--%>
<%--                </c:if>--%>
<%--                <c:forEach begin="1" end="${page.totalPages}" var="num">--%>
<%--                    <li--%>
<%--                            <c:if test="${num==page.pageNum}">--%>
<%--                                    class="active"--%>
<%--                            </c:if>class="page-item"><a href="${contextPaht}/user/queryUserPages?pageNum=${num}" class="page-link">${num}</a></li>--%>
<%--                </c:forEach>--%>
<%--                <c:if test="${page.pageNum>=page.totalPages}">--%>
<%--                    <li class="page-item disabled"><a href="#">Next</a></li>--%>
<%--                </c:if>--%>
<%--                <c:if test="${page.pageNum<page.totalPages}">--%>
<%--                    <li class="page-item "><a href="${contextPaht}/user/queryUserPages?pageNum=${page.pageNum+1}">Next</a></li>--%>
<%--                </c:if>--%>
...
<script>
    ...
    function queryUserPages(pageNum,pageSize) {

        let keywords=  $("#searchInput").val()
        $.ajax({
            url:'${contextPath}/user/queryUserPages',
            ...
            success:(res)=>{
                ...
                if(res.res.pageNum<2){
                    ...
                    content+='<li  class="page-item "><a onclick="queryUserPages('+(res.res.pageNum-1)+')" href="javascript:void(0)">Previous</a></li>'
                }

                for(let i=1;i<res.res.totalPages+1;i++){
                    content+= '<li onclick="queryUserPages('+i+')" class="page-item "><a  href="javascript:void(0)">'+i+'</a></li>'
                }

                if(res.res.pageNum>=res.res.totalPages){
                    content+='<li class="page-item disabled"><a>Next</a></li>'
                }else{
                    content+='<li  class="page-item "><a onclick="queryUserPages('+(res.res.pageNum+1)+')" href="javascript:void(0)">Next</a></li>'
                }
