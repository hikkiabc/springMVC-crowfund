    ...
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div  id="addProcess" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Process</span></div>
                    <div  id="addPng" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add Png</span></div>
        ...
        <form id="uploadForm" action="${contextPath}/process/uploadProcess" method="post" enctype="multipart/form-data">
            <input type="file"  name="file" id="file"  style="display: none">
            <input type="file"  name="png" id="png"  style="display: none">
...
$("#png").click()
        ...
        function deleteProcess(id,resouceName) {
            layer.confirm('delete'+resouceName+' not?', {icon: 3, title:'提示'}, function(index){
               $.ajax({
                   url:'${contextPath}/process/deleteProcess',
                   data:{id},
                   method:'post',
                   success(res){
                       console.log(res)
    ...
    function queryPages(pageNum,pageSize) {
        ...
        $.ajax({
            url:'${contextPath}/process/queryPages',
                ...
                let contentMain=''
                            res.res.data.forEach((i,index)=>{
                                contentMain+='                                <tr>\n' +
                                    ...
                                    '                                    <td>'+i.createtime+'</td>\n' +
                                    '                                    <td class=\'td-btn\'>\n' +
                                    '                                        <a href="javascript:void(0)" onclick="window.location.href=\'${contextPath}/process/processPng?id='+i.id+'\'" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="png">&#xE872;</i></a>\n' +
                                    ...
                                    '                                        <a href="javascript:void(0)" onclick="deleteProcess(\''+i.id+'\',\''+i.resourceName+'\')" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>\n' +
                                    '                                    </td>\n' +
                                    '                                </tr>'
                            })
