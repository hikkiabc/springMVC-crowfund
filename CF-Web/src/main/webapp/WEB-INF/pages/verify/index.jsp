...
<script>
    ...
    function queryPages(pageNum,pageSize) {
        ...
        $.ajax({
            url:'${contextPath}/verify/queryPages',
                ...
                let contentMain=''
                            res.res.data.forEach((i,index)=>{
                                contentMain+='                                <tr>\n' +
                                    ...
                                    '                                    <td class=\'td-btn\'>\n' +
                                    '                                        <a href="javascript:void(0)" onclick="window.location.href=\'${contextPath}/verify/details?taskId='+i.taskId+'&id='+i.member.id+'\'" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Details">&#xE872;</i></a>\n' +
